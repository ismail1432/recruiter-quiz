...
class InMemoryQuestionRepository implements QuestionRepositoryInterface
{
    ...
    public function getById(QuestionId $questionId): Question
    {
        foreach ($this->questions as $question) {
            if ($questionId->toString() === $question['id']) {
                return Question::create($questionId, $question['question'], $question['choices'], $question['answer']);
            }
        }
    ...
    public function getAll(): array
    {
        ...
        foreach ($this->questions as $question) {
            ...
            $questions[$question['id']] = Question::create(QuestionId::fromString($question['id']), $question['question'], $question['choices'], $question['answer']);
        }
